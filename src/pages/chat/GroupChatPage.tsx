...
import { ArrowLeft, Check, Copy, Crown, Loader2, MoreVertical, Paperclip, Pin, Reply, Search, Send, Settings, Shield, Smile, UserPlus, Users, X } from 'lucide-react';
import MobileLayout from '@/components/layouts/MobileLayout';
import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';
import { useAuth } from '@/contexts/AuthContext';
import { supabase } from '@/db/supabase';
import { addGroupMember, getGroup, getGroupMedia, getGroupMembers, getGroupMessages, getGroupPinnedMessages, leaveGroup, pinGroupMessage, removeGroupMember, searchGroupUsers, sendGroupFileMessage, sendGroupMessage, toggleGroupReaction, unpinGroupMessage } from '@/services/groups';
import type { Profile } from '@/types/types';
import type { Group, GroupMedia, GroupMember, GroupMessage, GroupPinnedMessage } from '@/types/groups';
